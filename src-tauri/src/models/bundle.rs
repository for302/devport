...
/// Dynamic version resolution strategy for a component
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
#[serde(rename_all = "camelCase")]
pub enum ResolveStrategy {
    /// Node.js LTS via nodejs.org/dist/index.json
    NodejsLts,
    /// GitHub Releases API (e.g. git-for-windows)
    GithubRelease { repo: String },
    /// phpMyAdmin version.json API
    PhpMyAdminApi,
    /// Composer /versions API
    ComposerApi,
    /// MariaDB archive directory listing
    MariaDbArchive,
    /// PHP Windows downloads HTML scraping
    PhpWindows,
    /// ApacheLounge download page HTML scraping
    ApacheLounge,
}
...
pub struct BundleComponent {
    ...
    /// Dynamic version resolution strategy (None = use hardcoded URL only)
    #[serde(default)]
    pub resolve_strategy: Option<ResolveStrategy>,
}
...
impl BundleManifest {
    ...
    pub fn embedded() -> Self {
        ...
        components.insert("apache".to_string(), BundleComponent {
            ...
            version: "2.4.63".to_string(),
            file_name: Some("httpd-2.4.63-250207-win64-VS17.zip".to_string()),
            download_url: Some("https://www.apachelounge.com/download/VS17/binaries/httpd-2.4.63-250207-win64-VS17.zip".to_string()),
            ...
            resolve_strategy: Some(ResolveStrategy::ApacheLounge),
        });
        ...
        components.insert("mariadb".to_string(), BundleComponent {
            ...
            resolve_strategy: Some(ResolveStrategy::MariaDbArchive),
        });
        ...
        components.insert("node".to_string(), BundleComponent {
            ...
            version: "22.13.1".to_string(),
            file_name: Some("node-v22.13.1-win-x64.zip".to_string()),
            download_url: Some("https://nodejs.org/dist/v22.13.1/node-v22.13.1-win-x64.zip".to_string()),
            size_bytes: 30_000_000, // ~30MB
            sha256: None,
            install_path: "runtime/nodejs".to_string(),
            executable_path: Some("node-v22.13.1-win-x64/node.exe".to_string()),
            ...
            resolve_strategy: Some(ResolveStrategy::NodejsLts),
        });
        ...
        components.insert("php".to_string(), BundleComponent {
            ...
            file_name: Some("php-8.4.3-nts-Win32-vs17-x64.zip".to_string()),
            download_url: Some("https://windows.php.net/downloads/releases/php-8.4.3-nts-Win32-vs17-x64.zip".to_string()),
            ...
            resolve_strategy: Some(ResolveStrategy::PhpWindows),
        });
        ...
        components.insert("composer".to_string(), BundleComponent {
            ...
            download_url: Some("https://getcomposer.org/download/2.8.5/composer.phar".to_string()),
            ...
            resolve_strategy: Some(ResolveStrategy::ComposerApi),
        });
        ...
        components.insert("git".to_string(), BundleComponent {
            ...
            version: "2.48.1".to_string(),
            file_name: Some("PortableGit-2.48.1-64-bit.7z.exe".to_string()),
            download_url: Some("https://github.com/git-for-windows/git/releases/download/v2.48.1.windows.1/PortableGit-2.48.1-64-bit.7z.exe".to_string()),
            ...
            resolve_strategy: Some(ResolveStrategy::GithubRelease {
                repo: "git-for-windows/git".to_string(),
            }),
        });
        ...
        components.insert("phpmyadmin".to_string(), BundleComponent {
            ...
            file_name: Some("phpMyAdmin-5.2.2-all-languages.zip".to_string()),
            download_url: Some("https://files.phpmyadmin.net/phpMyAdmin/5.2.2/phpMyAdmin-5.2.2-all-languages.zip".to_string()),
            ...
            resolve_strategy: Some(ResolveStrategy::PhpMyAdminApi),
        });
